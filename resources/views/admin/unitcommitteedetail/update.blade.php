...
@section('content')
    ...
    <form id="quickForm" novalidate="novalidate" method="POST" action="{{ route('admin.unitcommitteedetails.update') }}"
        enctype="multipart/form-data">
        @csrf
        <input name="id" id="" value="{{ $unitcommitteedetail->id }}" hidden>
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <input style="width:auto;" type="text" name="name" class="form-control" id="name"
                    value="{{ $unitcommitteedetail->name }}" autocomplete="off">
            </div>
            <div class="form-group">
                <label for="phone">Phone</label>
                <input style="width:auto;" type="text" name="phone" class="form-control" id="phone"
                    value="{{ $unitcommitteedetail->phone }}">
            </div>
            <div class="form-group">
