...
@section('content')
    ...
    <!-- Content Header (Page header) -->
        ...
        <form id="quickForm" novalidate="novalidate" method="POST" action="{{ route('admin.unit.store') }}"
        ...
        <div class="card-body">
            <div class="form-group">
                <label for="name">Unit Name</label><span style="color:red; font-size:large"> *</span>
