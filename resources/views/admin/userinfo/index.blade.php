...
<div class="row mb-2">
    <div class="col-sm-6 mb-2">
        ...
        {{-- <a href="{{ url('admin/$userinfo/create') }}"><button class="btn-primary btn-sm"><i class="fa fa-plus"></i>Add
                $user Info</button></a> --}}
    </div><!-- /.col -->
</div><!-- /.row -->
...
<table class="table table-bordered table-hover">
    ...
    <tbody>
        ...
        <tr data-widget="expandable-table" aria-expanded="false">
            <td> 
                <img id="preview1" src="{{ asset('uploads/images/profileimage/' . $user->photo) }}" style="width: 80px; height:80px" />
            </td>
            <td>{{ $user->name ?? '' }}</td>
            {{-- <td>{{ $user->email ?? '' }}</td> --}}
            ...
            <td>
                ...
                <a href="{{ url('admin/userinfo/show/' .$user->id) }}">
    ...
    <div class="modal fade" id="delete{{ $user->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-danger" data-bs-dismiss="modal">No</button>
                    <a href="{{ url('admin/userinfo/destroy/' . $user->id) }}">
                        <button type="button" class="btn btn-danger">Yes
                        </button>
                    </a>
                </div>
